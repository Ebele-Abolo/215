...
try:
    ...
    sensor_lidar_spawn_point = carla.Transform(carla.location x,y,andz
                                                carla.rotation_pitch=0.000000,yaw=90.0,roll=0.000000)
    ...
    visualise_lidar_using_mayavi = mlab.points3d(10,10,10,10, mode='point', Add colormap='gituplat', figure=lidar_figure)
